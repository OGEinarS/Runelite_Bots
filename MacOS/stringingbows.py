...
# Color definitions
c_bow_unstrung = "129012"
c_bowstring = "BD0C0C"
c_bow_finished = "4599FF"
c_bank_b = "FFFFA400"
c_bank_all = "FFFF6B6B"
...
def main():
    ...
    try:
        ...
        while True:
            ...
            string = count_items_full_screen(c_bowstring, 1, 50)
            uf_bow = count_items_full_screen(c_bow_unstrung, 1, 50)
            f_bow = count_items_full_screen(c_bow_finished, 1, 50)
            ...
            if current_state == "MAIN_HANDLE":
                ...
                if IsColourFound(c_idle, tolerance=25):
                    ...
                    find_and_click_center(c_bow_unstrung, tolerance=1)
                    humanpause(0.5)
                    find_and_click_center(c_bowstring, tolerance=1)
                    humanpause(1)
                    pyautogui.press("space")


            elif current_state == "BANK_HANDLE":
                if string >= 14 and uf_bow >= 14:
                    current_state = "CRAFT_HANDLE"
                    pyautogui.press("esc")
                    continue
