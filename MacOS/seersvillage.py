...
# Color Definitions
c_i_camelot_tp = "21758B"
c_a_obstacle = "FF6FE51B"
c_a_grace = "FFB31BE5"
c_t_tp_activate = "FF46CAED"
c_a_stop = "FFBD3357"
        ...
        while True:
            ...
            if current_state == "SCAN":
                if IsColourFound(c_idle, tolerance=35):
                    find_and_click_center(c_a_obstacle, tolerance=1)
                    humanpause(0.5)

                if IsColourFound(c_a_grace, tolerance=1):
                    find_and_click_center(c_a_grace, tolerance=1)
                    humanpause(0.5)
