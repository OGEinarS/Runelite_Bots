...
# Color definitions
c_dragon_leather = "129012 "
c_dragon_body = "BD0C0C"
c_needle = "AAFFAA"
c_bank_b = "FFFFA400"
c_bank_all = "FFFF6B6B"
...
def print_player_stats(chisel=0,staminapot=0, bloodrunes=0, housetp=0, dense_e_b=0, dark_e_b=0, dark_essense=0,
                       hp=0, prayer=0, run=0, current_state=0, boss=0, teak=0, string=0, uf_bow=0, f_bow=0, d_leather=0,d_body=0):
...
def main():
    ...
    try:
        ...
        while True:
            ...
            d_leather = count_items_full_screen(c_dragon_leather, 1, 50)
            d_body = count_items_full_screen(c_dragon_body, 1, 50)
            ...
            if current_state == "MAIN_HANDLE":
                ...
                if d_leather <= 0 or d_body >= 7:
                    current_state = "BANK_HANDLE"


                if IsColourFound(c_idle, tolerance=25):
                    find_and_click_center(c_needle, tolerance=1)
                    humanpause(0.5)
                    find_and_click_center(c_dragon_leather, tolerance=1)
                    humanpause(1)
